          ...
          @if ($food->count() > 0)
            ...
            <tr>
                ...
                <td>
                  ...
                  <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteModal{{$f->id}}"><i class="fas fa-trash pr-1"></i>Hapus</button>
                  <!-- Delete Modal -->
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p>Anda yakin ingin menghapus {{$f->nama}} ?</p>
                        </div>
